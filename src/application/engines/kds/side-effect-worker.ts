...
export class SideEffectWorker {
  ...
  constructor(dependencies: SideEffectWorkerDependencies) {
    if (dependencies.stalePendingAfterMs !== undefined) {
      requireNonNegativeInteger(dependencies.stalePendingAfterMs, 'stalePendingAfterMs');
    }
    if (dependencies.batchSize !== undefined) {
      requirePositiveInteger(dependencies.batchSize, 'batchSize');
    }
