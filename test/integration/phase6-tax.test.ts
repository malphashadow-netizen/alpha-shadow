...
describe('Phase 6 live acceptance', () => {
  ...
  beforeAll(async () => {
    ...
    for (const file of ['001_app_login.sql', '002_app_login_rbac.sql', '004_app_login_phase4.sql', '005_app_login_catalog.sql', '006_phase6_tax.sql', '016_tenant_tax_write.sql']) {
